/* **************** LDD:2.0 s_11/lab4_periodic_timers_alt_new.c **************** */
/*
...
{
	struct my_data *dat = from_timer(dat, t, timer);
...
static int __init my_init(void)
{
	...
	for (d = data_array, i = 0; i < 2; i++, d++) {
		timer_setup(&d->timer, my_timer_func, 0);
...
MODULE_DESCRIPTION("LDD:2.0 s_11/lab4_periodic_timers_alt_new.c");
