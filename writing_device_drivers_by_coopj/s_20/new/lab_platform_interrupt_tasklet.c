/* ************ LDD:2.0 s_20/new/lab_platform_interrupt_tasklet.c ************ */
/*
...
{
	struct my_dat *mdata = (struct my_dat *)data;
	atomic_inc(&counter_th);
	mdata->jiffies = jiffies;
...
MODULE_DESCRIPTION("LDD:2.0 s_20/new/lab_platform_interrupt_tasklet.c");
